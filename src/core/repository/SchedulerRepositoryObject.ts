...
export default class SchedulerRepositoryObject implements ISchedulerRepository {
    ...
    importScheduler(data?: any): Scheduler {
        if (data != undefined && data != null) {
            ...
            return new Scheduler(new Date(data.from), new Date(data.to), data.serialize, data.jobs);
        }
